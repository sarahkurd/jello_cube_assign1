...
int main()
{
  ...
  jello.dt=0.0005000;
  jello.n=5;
  jello.kElastic=400.0;
  jello.dElastic=0.25;
  jello.kCollision=2000.0;
    ...
    for (j=0; j<= jello.resolution-1; j++)
      for (k=0; k<= jello.resolution-1; k++)
      {
        ...
        jello.forceField[i * jello.resolution * jello.resolution 
          + j * jello.resolution + k].x = 0.05;
        jello.forceField[i * jello.resolution * jello.resolution 
          + j * jello.resolution + k].y = -0.07;
        jello.forceField[i * jello.resolution * jello.resolution 
          + j * jello.resolution + k].z = 0.04;
      }
